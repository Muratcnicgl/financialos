...
| H4 | Para birimi / dil / saat dilimi / kategori seti kullanıcı başına | Claude | P3.5.3 | 🟡 **saat dilimi TAMAM** (BUG #197 + **#237** — #197'nin kapsamı yarımdı, #237 ile TÜM kullanıcı-bağlamlı yollara taşındı ve statik kapıya bağlandı); para birimi/locale **alan olarak** var, görüntüleme aşaması ADR-042 ile P8 öncesine planlandı |
