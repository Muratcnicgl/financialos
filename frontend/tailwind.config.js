    ...
    extend: {
      ...
      colors: {
        ...
        brand: {
          ...
          300: '#a5b4fc',
          400: '#818cf8',
          500: '#5b5fe8',   // A11Y-005 (BUG #441): beyaz metin 4.47 → 4.94
          600: '#4f46e5',
          700: '#4338ca',
          800: '#3730a3',
          900: '#312e81',
        ...
        positive: {
          ...
          400: '#34d399',
          500: '#10b981',
          600: '#047857',   // A11Y-005 (BUG #441): beyazda 3.77 → 5.48 (700 ile aynı)
          700: '#047857',
          800: '#065f46',
          900: '#064e3b',
          950: '#022c22',
        ...
        negative: {
          ...
          300: '#fca5a5',
          400: '#f87171',
          500: '#dc2626',   // A11Y-005 (BUG #441): beyazda 3.76 → 4.83 (600 ile aynı)
          600: '#dc2626',
          700: '#b91c1c',
          800: '#991b1b',
          900: '#7f1d1d',
        ...
        warn: {
          ...
          400: '#fbbf24',
          500: '#f59e0b',
          600: '#b45309',   // A11Y-005 (BUG #441): beyazda 3.19 → 5.02 (700 ile aynı)
          700: '#b45309',
          800: '#92400e',
          900: '#78350f',
          950: '#451a03',
