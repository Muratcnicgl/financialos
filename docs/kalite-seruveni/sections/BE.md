...
- **Durum:** ✅ KAPANDI — **BUG #402 (11 Eyl 2026):** approve her başarısızlığı 422'ye, reject her başarısızlığı 404'e çeviriyordu ("zaten reddedildi" 404 dönüyordu — aksiyon vardı). Karar: yürütücünün dict sözleşmesi KORUNDU (ADR-001 enforcement kod seviyesinde; istisna hiyerarşisi her handler'ı değiştirirdi), sınıf yürütücüde etiketlenir (`rule_blocked` zaten vardı; `kod="zaten"|"bulunamadi"` eklendi), statü tek yerde çevrilir (`_yurutucu_hatasi`): 403 kural engeli · 409 durum çatışması · 404 yok · 422 girdi. İki mevcut sözleşme testi bilinçli güncellendi (422/404 → 409). Kapı `tests/test_aksiyon_hata_sinifi_kapisi.py`: çevirici dört sınıf + gerçek yollar (kural ihlali 403, çatışma 409 ×2, girdi 422, yok 404); mutasyonla doğrulandı. Frontend mesajı okur, statüye bakmaz — etkilenmez.
