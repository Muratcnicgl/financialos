...
- **Branch:** `main` (= origin senkron). **Para artık Decimal** — `Numeric(19,4)` canlı DB'de (ADR-030, M5); iç aritmetik Decimal, public sınır `floatify`→float (B1). Canlı DB head **`e7f8a9b0c1d2`** (BUG #281, 11 Ağu — `feedback`'e teşhis alanları; önceki
...
- **Bug numaralandırma:** sonraki `BUG #313`'ten (tavan #312). **11 Ağu akşam turu — beta
