              ...
              <div key={env.id} className="card p-3">
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button type="button" onClick={() => remove(env.id)} className="text-zinc-500 dark:text-zinc-400 hover:text-negative-500 min-w-[44px] min-h-[44px] inline-flex items-center justify-center shrink-0 -my-2" title="Sil">
