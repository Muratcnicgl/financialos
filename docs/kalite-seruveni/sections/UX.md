...
- **Durum:** ✅ KAPANDI (modal) · ⛔ (arşivle) — BUG #354 (5 Eyl) onay metnini davranışa bağlamıştı; BUG #461 (13 Eyl 2026) `window.confirm`'i ortak erişilebilir `Modal` ile değiştirdi (odak tuzağı, Escape, aria-modal); uyarı ve silinecekler sabitlerden çizilir, backend kapısı `test_koc_sifirlama_onayi_kapisi` aynı sabitleri okur (metin ile davranış tek yerde). "Arşivle (sil yerine gizle)" bilinçli yok: NE SİLİNECEĞİ ürün kararı (BUG #354 notu) — yumuşak silme koç hafızası ve KVKK silme yolunu (hesapla birlikte tam silme) karmaşıklaştırır. Kapı: `frontend/src/koc-sifirlama-modal.test.jsx`.
...
- **Durum:** ✅ KAPANDI (BUG #265 / ADR-047, 7 Ağu 2026 → #433/#441, 13 Eyl 2026) — **dokunma hedefi ve kontrast KAPANDI ve
  ...
  girdisi görünür odaksızdı, düzeltildi (`a11y-odak-halkasi.test.jsx`). Kontrast eşiği BUG #441
  (13 Eyl 2026) ile 4.5:1'e çıktı ve 0 ihlalle koşuyor (A11Y-005). → ✅ KAPANDI.
