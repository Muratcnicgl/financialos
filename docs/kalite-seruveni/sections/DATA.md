...
- **Durum:** ✅ KAPANDI — M85 R3 doğrulama: para kolonları Numeric(19,4); interest_rate/lot_count Float ama para değil (models.py:183)
...
- **Durum:** ✅ KAPANDI — M85 R3 doğrulama: PRAGMA foreign_keys=ON (database.py:49)
...
- **Durum:** ✅ KAPANDI — M85 R3 doğrulama: journal_mode=WAL + busy_timeout + synchronous=NORMAL (database.py:50-52)
...
- **Durum:** 🔲 AÇIK — M85 R3 doğrulama: timezone karışık aware/naive (models.py:728 vs 142)
...
- **Durum:** 🔲 AÇIK — M85 R3 doğrulama: default=datetime.utcnow (3.12 deprecated) (models.py:142+)
...
- **Durum:** 🔲 AÇIK — M85 R3 doğrulama: hiç CheckConstraint yok (grep=0)
...
- **Durum:** 🟡 KISMEN — M85 R3 doğrulama: Goal.user_id nullable=True; app-katmanı garanti (models.py:872)
...
- **Durum:** 🔲 AÇIK — M85 R3 doğrulama: Transaction FK ondelete tanımsız; silme 409 ile elde (models.py:213; accounts.py:236)
...
- **Durum:** 🔲 AÇIK — M85 R3 doğrulama: updated_at yalnız Account+Goal; version_id yok
...
- **Durum:** 🔲 AÇIK — M85 R3 doğrulama: soft-delete/deleted_at yok (grep=0)
...
- **Durum:** 🔲 AÇIK — M85 R3 doğrulama: goal_type/status serbest String, bazıları SQLEnum tutarsız (models.py:862)
...
- **Durum:** ✅ KAPANDI — M85 R3 doğrulama: drop_all --force + onay guard + DATABASE_URL göster (setup_data.py:38)
...
- **Durum:** ✅ KAPANDI — M85 R3 doğrulama: NetWorthSnapshot para alanları Numeric(19,4) (models.py:599)
...
- **Durum:** 🔲 AÇIK — M85 R3 doğrulama: legacy Column(), mapped_column/Mapped[] yok
