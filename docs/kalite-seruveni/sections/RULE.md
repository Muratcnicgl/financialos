...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: modulo→gerçek tarih farkı, BUG #147 (rules_engine.py:298)
...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: effective değer kullanılıyor, BUG #148/#150 (rules_engine.py:309,325)
...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: today.day>1 bilinçli korundu, R3 ile doğru davranış belgelendi (rules_engine.py:325)
...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: para Numeric/Decimal (ADR-030); models.py Decimal-RULE-006 notu
...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: evaluate_credit_card_strategy test edildi (test_faz3_p1.py, test_card_strategy.py)
...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: ikisi de test edildi (test_decimal_precision.py, test_category_patterns.py)
...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: reel_butce alacakları bilinçli hariç tutar, belgelenmiş MC ayrımı (rules_engine.py:1974)
...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: current_amount max(.,0) klemp'li, BUG #132 (goal_engine.py:155)
...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: yatirim_deger yuvarlanmadan Decimal biriktirilip tek round; çift yuvarlama yok (rules_engine.py:1941)
...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: ADR-030 para Decimal(2dp), kalan_lot 4dp miktar — kasıtlı ayrım, sürüklenme yok (rules_engine.py:420)
...
- **Durum:** ✅ KAPANDI — M76 kod-doğrulaması: Account.balance Numeric(19,4), Goal.target_amount Numeric(14,2), köprü giderildi (models.py:183,875)
